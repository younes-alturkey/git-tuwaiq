...
namespace backend.Models.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserModel>().HasData(new UserModel { Id = 1, Name = "Mansovic", Email="Mansoviic@gmail.com", Password="P@assWord123" , ImgUrl = "https://i.picsum.photos/id/870/200/300.jpg?blur=2&grayscale&hmac=ujRymp644uYVjdKJM7kyLDSsrqNSMVRPnGU99cKl6Vs" , CreatedAt = DateTime.Now , UserName = "Mansovic"}) ;
